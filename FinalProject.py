...
curr_loc=input("Enter your present Location: ")
    
dest_loc=input("Enter your destination location: ")

try:
        
    precision=int(input('How Detailed Must the Result be? (1-5) with 1 being least detailed and vice-versa: '))
...
if (precision>=1 and precision<=5):
    ...
    fdir=open(r'C:\Users\smurk\OneDrive\Desktop\Directions.txt','w')
    ...
    f1=open(r'C:\Users\smurk\OneDrive\Desktop\WEATHERUPDATE.txt','w', encoding='utf-8')
    ...
    #os.startfile(r'C:\Users\smurk\OneDrive\Desktop\WEATHERUPDATE.txt')
    
    os.startfile(r'C:\Users\smurk\OneDrive\Desktop\Directions.txt')
